      ...
      <div className='max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10'>
        ...
        >
          <h1 className='text-6xl md:text-8xl font-black text-meow-charcoal mb-8 leading-[1.1]'>
            ...
            <span className='italic text-meow-accent relative inline-block'>
              But Cuter
              <svg
                className='absolute -bottom-2 left-0 w-full h-4 text-meow-accent/30'
                viewBox='0 0 100 20'
          ...
          <p className='max-w-lg text-lg text-meow-charcoal/60 mb-10 leading-relaxed font-medium'>
            The purr-fect way to share everything you do. Create a beautiful,
            cat-themed link card in seconds and let your personality shine.
          </p>
          ...
          <div className='flex flex-col sm:flex-row items-center gap-6 mb-12'>
            <div className='flex flex-col sm:flex-row items-center gap-4'>
              <Show when='signed-out'>
                <Link
                  href='/sign-up'
                  className='bg-meow-accent text-white px-10 py-5 rounded-3xl font-bold text-lg shadow-2xl shadow-meow-accent/30 hover:scale-105 transition-all active:scale-95 text-center'
                >
                  Create your card
                </Link>
              </Show>
              <Show when='signed-in'>
                <Link
                  href='/dashboard'
                  className='bg-meow-accent text-white px-10 py-5 rounded-3xl font-bold text-lg shadow-2xl shadow-meow-accent/30 hover:scale-105 transition-all active:scale-95'
                >
                  Go to Dashboard
                </Link>
              </Show>
        ...
        >
          ...
          <div className='bg-white p-8 rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] relative overflow-hidden flex flex-col items-center'>
            ...
            <p className='text-sm text-meow-charcoal/60 mb-8 font-medium'>
              Digital artist & treat connoisseur 🐾
            </p>
            {/* Mockup Footer Icons */}
            <div className='flex items-center gap-8 text-meow-charcoal/30 mb-8'>
              <Twitter size={22} />
              <Instagram size={22} />
              <Youtube size={22} />
            </div>
